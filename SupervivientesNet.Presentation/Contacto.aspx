<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Contacto.aspx.cs" Inherits="SupervivientesNet.Presentation.Contacto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
                <asp:TextBox class="form-control" ID="txtEmail" type="email" runat="server" placeholder="Tu Email.."></asp:TextBox>
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
    <asp:TextBox class="form-control"  ID="txtComment" runat="server" placeholder="Ingresa tu comentario.." Height="102px"></asp:TextBox>

                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Campo Obligatorio" ControlToValidate="txtComment" ForeColor="Red"></asp:RequiredFieldValidator>
                <asp:CustomValidator ID="CustomValidator4" runat="server" ErrorMessage="*Máximo 300 caracteres" ControlToValidate="txtComment" ForeColor="Red" OnServerValidate="CustomValidator4_ServerValidate"></asp:CustomValidator>
        </div>
    </div>  
