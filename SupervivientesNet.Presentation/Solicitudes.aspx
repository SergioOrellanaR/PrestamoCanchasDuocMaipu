<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Solicitudes.aspx.cs" Inherits="SupervivientesNet.Presentation.Solicitudes" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
        <asp:DropDownList class="form-control" ID="ddlBlock" runat="server">
        ...
        <div class="col-lg-10">
        <asp:DropDownList class="form-control" ID="ddlFacility" runat="server">
    ...
    <div class="form-group">
        <div class="col-lg-offset-2 col-lg-10">
         ...
         <asp:Label ID="lblMessage" runat="server" Text="" class="col-lg-2 control-label"></asp:Label>
    </div>
    </div>
</asp:Content>
